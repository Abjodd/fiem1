...
import { scheduleGenerateApi, generateDays, authConfig } from '../../../services/Purchasing/ScheduleGenerate/ScheduleGenerate.js'
...
const anyHaveInd = selArr.some(k => items.find(i => i._key === k)?.indicator)
  ...
  navigate('/purchasing/ScheduleGenerate/schedule-lines', {
    state: {
