        ...
        <tbody>
          <tr className="border-b border-[#f0f0f0]">
            ...
            {calCols.map((cd) => {
              ...
              const deliveryQty  = line ? (line.deliverySchedule || 0) : 0
                    ...
                    >
                      ...
                      <span className="flex items-baseline gap-0.5 justify-center">
                        <span className="text-[12px] font-bold tabular-nums leading-none" style={{ color: cellText }}>
                          {confirmedQty > 0 ? confirmedQty.toLocaleString() : deliveryQty.toLocaleString()}
                        </span>
                        {unit && (
            ...
            {/* Row total: delivery schedule sum */}
            <td
  ...
  return (
    <PageLayout>
      <style>{`
        ...
        /* Hover effect on confirmed/pending date cells */
        .date-cell {
        ...
        /* Mobile: collapse description on small screens */
        ...
        <div className="bg-white border-b border-[#e5e5e5] px-4 sm:px-8 lg:px-12 py-5 flex-shrink-0 anim-fade">
          ...
          >
            ...
            <div className="text-right">
              <div className="text-[11px] uppercase tracking-wider text-[#6a6d70] font-semibold mb-1">Agreement</div>
