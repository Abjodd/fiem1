...
export default function DaikinPortal() {
  const userName = "Arjun"; // Replace with logged-in user
        ...
        <div className="max-w-[1480px] mx-auto px-8 py-5 flex items-center justify-between">
          ...
          <ul className="hidden lg:flex items-center gap-9 text-[14px]">
            {['Home', 'Modules'].map((item, i) => (
              <li key={item}>
                <a href="#" className={`relative group ${i === 0 ? 'text-white' : 'text-white/55 hover:text-white'} transition-colors`}>
                  {item}
        ...
        <div className="relative max-w-[1480px] mx-auto px-8 w-full grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 relative z-10">
            ...
            <div className="anim-fade-up stagger-3 mt-10 flex flex-wrap items-center gap-4">
              <button className="btn-shine group relative inline-flex items-center gap-3 px-7 py-4 bg-[#00A2E8] text-[#05080d] font-semibold tracking-wide rounded-full hover:bg-white transition-all duration-300 shadow-[0_0_40px_rgba(0,162,232,0.4)] hover:shadow-[0_0_60px_rgba(0,162,232,0.6)]">
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative">
                  ...
                  <svg width="140" height="78" viewBox="0 0 100 56" fill="none" className="relative">
                    <polygon points="0,0 30,0 15,56" fill="#0a1018"/>
                    <polygon points="15,0 45,0 30,56 0,56" fill="#00A2E8"/>
                    <text x="52" y="38" fill="#00A2E8" fontSize="22" fontWeight="800" fontFamily="Geist" letterSpacing="-0.5">DAIKIN</text>
                  </svg>
                </div>
              </div>
